        ...
        new POVButton(joy, WINCH_DOWN_BUTTON_ANGLE)
                .whenHeld(
                        new SequentialCommandGroup(
                            new RunCommand(climber::ScissorDown).deadlineWith(new WaitCommand(1)),
...
*/
        ...
        //feeder.setDefaultCommand(new InstantCommand(feeder::stopCells));
    }
